...
NETWORK = {
    ...
    'IPSC2': {
        'LOCAL': {
            'DESCRIPTION': 'KS DMR Basehor, KS - Master',
            'MODE': b'\x6A',
            'FLAGS': b'\x00\x00\x80\xDC',
            'PORT': 50002,
    ...
    'IPSC3': {
        'LOCAL': {
            'DESCRIPTION': 'K0USY c-Bridge Lawrence, KS - Master',
            'MODE': b'\x6A',
            'FLAGS': b'\x00\x00\x80\xDC',
            'PORT': 50003,
    ...
    'IPSC4': {
        'LOCAL': {
            'DESCRIPTION': 'W0WJB Kansas City, MO - Master',
            'MODE': b'\x6A',
            'FLAGS': b'\x00\x00\x80\xDC',
            'PORT': 50004,
            'RADIO_ID': binascii.unhexlify('00000004'),
            'AUTH_KEY': binascii.unhexlify('0000000000000000000000000000000000005651')
        },
        'MASTER': {
            'IP': '166.250.7.136',
            'MODE': b'\x6A',
